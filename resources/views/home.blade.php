...
<div class="container my-5 py-5">
    <div class="row h-100 mt-5">
        <div class="col-12 col-md-6">
            ...
            <button class="btnvisita">visita</button>
        </div>
        <div class="col-12 col-md-6">
...
<div class="container text-center">
    <div class="row">
        <div class="col-12 col-md-4">
            <i class="fab fa-angellist fa-2x mb-4 text-third"></i>
            <h5>EFICIENCIA
            </h5>
            <p>Lorem ipsum dolor sit amet</p>
        </div>
        <div class="col-12 col-md-4">
            <i class="fas fa-tachometer-alt fa-2x mb-4 text-third"></i>
            <h5>VELOCIDAD</h5>
            <p>Lorem ipsum dolor sit amet</p>
        </div>
        <div class="col-12 col-md-4">
            <i class="fas fa-hand-holding-usd fa-2x mb-4 text-third"></i>
            <h5>ECONOMIA</h5>
            <p>Lorem ipsum dolor sit amet</p>
        </div>
    </div>
